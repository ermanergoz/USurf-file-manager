...
class PropertiesDialog(var file: File) : DialogFragment() {
    ...
    override fun onCreateDialog(savedInstanceState: Bundle?): Dialog {
        return activity?.let {
            ...
            val dialogView: View = inflater.inflate(R.layout.dialog_properties, null)
            ...
            if (file.isDirectory) {
                ...
                fileSizerogressBar.progress = getFileUsedStoragePercentage(file.path)
            } else {
                this.sizeTextView.text = getConvertedFileSize(file.length())
                fileSizerogressBar.progress = getFileUsedStoragePercentage(file.path, file.length())
            }
            ...
            usedStorageProgressBar.progress = getUsedStoragePercentage(file.path)
