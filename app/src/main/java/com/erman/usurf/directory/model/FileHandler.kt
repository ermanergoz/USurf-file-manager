...
import com.erman.usurf.home.model.getFolderSize
import com.erman.usurf.home.model.getStorageDirectories
    ...
    if (sourceFile.isDirectory) {
        ...
        for (i in sourceFile.listFiles()!!.indices) {
            copyToExtCard(
                ...
                copyOrMoveDestination + separator + sourceFile.name,
                context
            )
        }
    } else {
        ...
        for (i in selectedDirectories.indices) {
            if (selectedDirectories[i].isDirectory) {
                zipFolder(
                    selectedDirectories[i].listFiles()!!.toList(),
                    output,
                    folderName + separator + selectedDirectories[i].name
                )
            } else {
